...
public class UserMonitor implements ActionListener {
    ...
    private JTextField jTextField;//登录界面中的文本框
    private JPasswordField jPasswordField;//登录界面中的密码框
    ...
    public void actionPerformed(ActionEvent e) {//点击登录按钮
        ...
        if (e.getSource() == jButton1) {
            ...
            User user = userImpl.selectByUserName(userName); 
            if (user != null) {
                if (user.getUserPassword().equals(userPassword)) 
                {
                    ...
                    CarUi.initializeRootContainer();//初始化操作界面
                } else {
                    JOptionPane.showMessageDialog(
                            null,
                            "密码错误！\n请重新输入！",
