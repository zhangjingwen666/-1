...
public class LoginFrame {
    ...
    private static JFrame register = new JFrame("注册");
    ...
    public static void initSignIn() {
        ...
        jLabel1.setFont(font);//设置标签和按钮的字体样式
        ...
        UserMonitor userMonitor = new UserMonitor(signIn, jButton1, jButton2, jTextField, jPasswordField);
        jButton1.addActionListener(userMonitor);
        jButton2.addActionListener(userMonitor);
    }
}